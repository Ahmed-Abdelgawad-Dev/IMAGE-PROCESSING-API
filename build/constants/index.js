...
// My existing pics
var MYImages = ['pic1', 'pic2', 'pic3', 'pic4', 'pic5'];
exports.MYImages = MYImages;
//Path to the images
var IMAGES_PATH = path_1.default.resolve(__dirname, '../images');
exports.IMAGES_PATH = IMAGES_PATH;
// Path to the output resized images
var IMAGES_OUTPUT_PATH = path_1.default.resolve(__dirname, '../images/new_images');
